...
function DiagnosisHistory({ patient }) {
  ...
  // Latest six months for the chart (oldest → newest)
  const chartData = [...patient.diagnosis_history]
    .slice(0, 6)
    .reverse();

  // Latest diagnosis (Mar 2024)
      ...
      <div className="bg-[#F4F0FE] rounded-2xl p-6 w-[550px] container text-left">
        ...
        <div className="flex justify-between gap-4">
          ...
          <div className="flex-1">
            ...
            <h3 className="text-xl font-semibold mb-6 blood-pressure">
              Blood Pressure
            </h3>
          ...
          <div className="w-[180px] flex flex-col justify-center items-start">
            ...
            <div className="pb-6 border-b border-gray-300">
              ...
              <p className="text-2xl font-bold flex flex-start">
                {latest.blood_pressure.systolic.value}
              </p>

              <p className="mt-2 text-sm text-gray-500 flex flex-start value">
